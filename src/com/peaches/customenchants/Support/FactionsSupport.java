...
public class FactionsSupport
{
    public static boolean isFriendly(Player player, Player other)
    {
        ...
        if (ChatColor.stripColor(o.getName()).equalsIgnoreCase("Wilderness")) {
            return false;
        }
        if (r.isFriend()) {
            return true;
    ...
    public static boolean isFriendly(Faction player, Faction other)
    {
        ...
        if (ChatColor.stripColor(other.getName()).equalsIgnoreCase("Wilderness")) {
            return false;
        }
        if (r.isFriend()) {
            return true;
    ...
    public static boolean inTerritory(Player P)
    {
        ...
        if (ChatColor.stripColor(player.getFaction().getName()).equalsIgnoreCase("Wilderness")) {
            return false;
        }
