...
class KingdomsSupport {
    ...
    public static boolean isFriendly(Player player, Player other) {
        ...
        return kp.getKingdom() == ko.getKingdom() || kp.getKingdom() != null && kp.getKingdom().isAllianceWith(ko.getKingdom());
    }

    public static boolean inTerritory(@NotNull Player P) {
